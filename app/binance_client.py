...
- Выставление Post-Only лимитных ордеров.
- Получение текущей позиции.
- Логирование истории стакана и позиций в локальные CSV.
- Функция init_data() для инициализации папки и файлов.
"""
...
# Пути к данным
BASE_DIR = Path(__file__).resolve().parent.parent    # корень проекта, например /app
...
def init_data() -> None:
    """
    Создать папку data и CSV-файлы с заголовками (если их ещё нет).
    Вызывать однократно при старте приложения.
    """
